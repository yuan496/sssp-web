package com.engineer.sssp.web.log.listener;
 ...
 *
 * <p>Only needed for non-default logback initialization, for example with a custom
 * config location or a refresh interval. By default, logback will simply read its
 * configuration from a "logback.xml" or "logback.groovy" file in the root of
 * the classpath.
 *
 ...
 * {@code web.xml}. In a J2EE web application, logback is usually set up
 * via LogbackConfigListener, delegating to LogbackWebConfigurer underneath.
 * 
 * @author fangzhibin
 * @since 2.3.0
 * @createDate 2015年10月20日 下午2:58:49
...
public abstract class LogbackConfigurer {
	 ...
	 *        location (e.g. "classpath:logback.xml"), an absolute
	 *        file URL (e.g.
	 *        "file:C:/logback.xml), or a plain absolute path in the file system (e.g. "
	 *        C:/logback.xml")
