		...
		<table class="data">
			...
			<c:forEach items="${page.content}" var="role">
				<tr>
					...
					<td><a href="${pageContext.request.contextPath }/web/role/role/${role.id}">edit</a></td>
					<td><a href="${pageContext.request.contextPath }/web/role/delete?id=${role.id}">delete</a></td>
				</tr>
			</c:forEach>
			<tr>
				<td colspan="8">
